package net.casian.craftmastery.block.custom;
...
public class RollingMillBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (blockEntity instanceof RollingMillBlockEntity) {
                ItemScatterer.spawn(world, pos, (RollingMillBlockEntity)blockEntity);
